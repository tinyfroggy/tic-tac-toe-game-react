  ...
  return (
    ...
    <div className='board'>
      ...
      <div className='board__body'>
        {squares.map((sq, ix) => (
          <BoardCard key={ix} index={ix} user={sq} 
      ...
      <div className='board__footer'>
        ...
        <div className='card bg-blue'>
          ...
          <strong className='test-2xl'>{ties.x}</strong>
        </div>
        {/* === blue card === */}
        ...
        <div className='card bg-light'>
          ...
          <strong className='test-2xl'>{ties.x + ties.o}</strong>
        </div>
        {/* === light card === */}
        ...
        <div className='card bg-yellow'>
          ...
          <strong className='test-2xl'>{ties.o}</strong>
        </div>
        {/* === yellow card === */}
